...
function register_countdown_stuff() {
  wp_enqueue_style( 'count-styles', get_stylesheet_directory_uri() . 'https://cdnjs.cloudflare.com/ajax/libs/flipclock/0.7.8/flipclock.min.css' );
  wp_enqueue_script( 'count-lib', get_stylesheet_directory_uri() . 'https://cdnjs.cloudflare.com/ajax/libs/flipclock/0.7.8/flipclock.min.js', array( 'jquery' ), '1.0', true );
