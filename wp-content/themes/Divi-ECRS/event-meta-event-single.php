...
<?php
  ...
  if(!empty($class_description_field) && $class_description_field == 'true') {
    ?>
<div class="optional-button"><a title="Class descriptions for this event" class="button no-line" href="<?php echo esc_url( add_query_arg( 'event', $post->post_name, site_url( '/class-descriptions' ) ) )?>" data-ytta-id="-">Classes</a></div>
<?php } ?>
